...
const Icons = {
  ...
  magnifying: 'M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 15.803a7.5 7.5 0 0010.607 10.607z',
...
const vendorNav: NavSection[] = [
  {
    items: [
      ...
      { label: 'Knowledge Base', href: '/vendor/knowledge', iconPath: Icons.newspaper },
    ],
  },
  {
    title: 'Account',
...
const agencyNav: NavSection[] = [
  {
    items: [
      ...
      { label: 'Knowledge Base', href: '/agency/knowledge', iconPath: Icons.newspaper },
    ],
  },
];
...
const analystNav: NavSection[] = [
  {
    items: [
      ...
      { label: 'Reporting', href: '/analyst/reporting', iconPath: Icons.chartBar },
    ],
  },
  {
    title: 'Tools',
...
const adminNav: NavSection[] = [
  {
    items: [
      ...
      { label: 'Knowledge Base', href: '/admin/knowledge', iconPath: Icons.newspaper },
      { label: 'User Feedback', href: '/admin/feedback', iconPath: Icons.envelope },
    ],
  },
];
