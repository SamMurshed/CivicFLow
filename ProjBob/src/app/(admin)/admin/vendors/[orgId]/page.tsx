...
import VendorStatusForm from '@/components/admin/VendorStatusForm';
...
/**
 * Admin — vendor organisation detail and status management page.
 *
 * Admins can view the full vendor profile and toggle the organisation's
 * active status.  The form is rendered as a client component to handle
 * the server action response inline.
 *
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div>
            ...
            <p className="mt-0.5 text-sm text-slate-500">Vendor Organisation</p>
          </div>
      ...
      <Card noPadding>
        <CardHeader
          title="Vendor Status"
          description="Activate or deactivate this vendor organisation."
        />
        <CardSection>
          <VendorStatusForm
